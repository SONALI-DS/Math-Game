...
import MathmindAdministration.AdminAPI;
import java.sql.*;
 ...
 * @author soni
 */
public class PlayerResult extends javax.swing.JFrame {

    /**
     * Creates new form PlayerResult
     */
    public PlayerResult() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/icons8-improvement-40.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Showcard Gothic", 1, 40)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 51, 102));
        jLabel2.setText("Player Results");
        ...
        jLabel3.setText("Filter Player By Score :");
        ...
        jTable1.setGridColor(new java.awt.Color(255, 51, 102));
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/icons8-right-arrow-50.png"))); // NOI18N
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        try
        {
            Connection con=ConnectionProvider.getCon();
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery("select *from player where score>="+score+"");
            jTable1.setAutoResizeMode(jTable1.AUTO_RESIZE_OFF);
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlayerResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
